...
window.onload = function () {
    ...
    function showAnswer1(){
        ...
        const img = document.getElementById('quest__img1');
        if (img.className.includes("img__down")){
            img.classList.remove('img__down');
            img.classList.add('img__up');
            img.setAttribute("src", "./assets/images/up.png" );
        }
        else{
            img.classList.add('img__down');
            img.classList.remove('img__up');
            img.setAttribute("src", "./assets/images/down.png" );
        }
    }
    function showAnswer2(){
        ...
        const img = document.getElementById('quest__img2');
        if (img.className.includes("img__down")){
            img.classList.remove('img__down');
            img.classList.add('img__up');
            img.setAttribute("src", "./assets/images/up.png" );
    ...
    function showAnswer3(){
        ...
        const img = document.getElementById('quest__img3');
        if (img.className.includes("img__down")){
            img.classList.remove('img__down');
            img.classList.add('img__up');
            img.setAttribute("src", "./assets/images/up.png" );
